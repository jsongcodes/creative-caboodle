...
var _useTabs = _interopRequireDefault(require("@mui/base/useTabs"));
var _styles = require("@mui/material/styles");
var _animate = _interopRequireDefault(require("@mui/material/internal/animate"));
...
const TabsScroller = (0, _styles.styled)('div', {
  name: 'MuiTabs',
  slot: 'Scroller',
  overridesResolver: (props, styles) => {
    const {
...
const TabsIndicator = (0, _styles.styled)('span', {
  name: 'MuiTabs',
  slot: 'Indicator',
...
const TabsScrollbarSize = (0, _styles.styled)(_ScrollbarSize.default, {
  name: 'MuiTabs',
  slot: 'ScrollbarSize'
})({
  overflowX: 'auto',
...
const Tabs = /*#__PURE__*/React.forwardRef(function Tabs(inProps, ref) {
  ...
  const {
    tabsContextValue
  } = (0, _useTabs.default)((0, _extends2.default)({}, props, {
  ...
  const getTabsMeta = () => {
    ...
    if (tabsNode) {
      ...
      tabsMeta = {
        ...
        scrollLeftNormalized: (0, _utils.unstable_getNormalizedScrollLeft)(tabsNode, theme.direction),
  ...
  const updateIndicatorState = (0, _utils.unstable_useEventCallback)(() => {
    const {
      tabsMeta,
      tabMeta
    } = getTabsMeta();
  ...
  const moveTabsScroll = delta => {
    ...
    if (vertical) {
      ...
      // Fix for Edge
      scrollValue *= isRtl && (0, _utils.unstable_detectScrollType)() === 'reverse' ? -1 : 1;
    }
    scroll(scrollValue);
  };
  const getScrollSize = () => {
  ...
  const scrollSelectedIntoView = (0, _utils.unstable_useEventCallback)(animation => {
    const {
      tabsMeta,
      tabMeta
    } = getTabsMeta();
  ...
  const updateScrollButtonState = (0, _utils.unstable_useEventCallback)(() => {
    if (scrollable && scrollButtons !== false) {
      ...
      if (vertical) {
        ...
        const scrollLeft = (0, _utils.unstable_getNormalizedScrollLeft)(tabsRef.current, theme.direction);
  ...
  React.useEffect(() => {
    ...
    const win = (0, _utils.unstable_ownerWindow)(tabsRef.current);
  ...
  const handleTabsScroll = React.useMemo(() => (0, _utils.unstable_debounce)(() => {
    updateScrollButtonState();
  }), [updateScrollButtonState]);
  React.useEffect(() => {
    return () => {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_TabsUnstyled.TabsContext.Provider, {
    value: tabsContextValue,
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(TabsRoot, (0, _extends2.default)({
      ...
      children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, /*#__PURE__*/(0, _jsxRuntime.jsxs)(TabsScroller, {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_TabsList.default, {
          "aria-label": ariaLabel,
          "aria-labelledby": ariaLabelledBy,
          variant: variant,
